...
- Added new methods {Tree::TreeNode#in_degree} and {Tree::TreeNode#out_degree}
...
- Added new methods Tree::TreeNode#to_json and Tree::TreeNode::json_create to
  convert to/from the JSON format. Thanks to
  Dirk[http://github.com/railsbros-dirk] for this change.

== Release 0.6.1 Changes

- Deprecated the {Tree::TreeNode#depth} method as it was returning an incorrect
  depth value. Have introduced a new replacement method
  {Tree::TreeNode#node_depth} which returns the correct result.
