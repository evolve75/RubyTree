...
* RubyTree now allows proper sub-classing of {Tree::TreeNode}. Thanks to
  {https://github.com/jack12816 jack12816} for this.

* RubyTree now correctly handles creating detached copies of unclonable objects
  such as +:symbol+, +true|false+, etc. Thanks to {https://github.com/igneus
  igneus} for this.
