...
{<img src="https://badge.fury.io/rb/rubytree.png" alt="Gem Version"
...
See {file:API-CHANGES.rdoc} for description of potentially backwards
incompatible API changes.

== EXAMPLE:

See the example at {examples/example_basic.rb}[examples/example_basic.rb] for a basic use case.

{include:file:examples/example_basic.rb}

== REQUIREMENTS:

* {Ruby}[http://www.ruby-lang.org] 1.8.x, 1.9.x, 2.0.x, or 2.1.0x.
